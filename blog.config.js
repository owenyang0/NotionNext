...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OwenYang（木易）', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '互联网人、电子垃圾体验者、挨踢FEer、木易跟打器作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.owenyang.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'owenyang,木易,木易某某,木易跟打器,owen yang’s blog,木易博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/owenyang0', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/19951295', // B站主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://owenyang.top/img/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://registry.npmmirror.com/twikoo/1.6.39/files/dist/twikoo.min.js', // twikoo客户端cdn
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'ea8036d07ac9ad383c13ada3780f601b', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
